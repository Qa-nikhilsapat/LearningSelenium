...
//driver.findElement(By.className("gLFyf")).sendKeys("selenium interview questions");
//List<WebElement> list =driver.findElements(By.cssSelector("ul>li>div>div:nth-of-type(2)>*:first-child>span"));
